    ...
    with open("albums.txt","r") as albums:
        for line in albums:
            ...
            if new_album is None:
                ...
                #store the current album in the artists collcetion then create a new album object
                new_artist.add_album(new_album)
                new_album = Album(album_field, year_field,new_artist)
...
def create_checkfile(artist_list):
    """
    create a check file from the object data for comparision with the orginal file
